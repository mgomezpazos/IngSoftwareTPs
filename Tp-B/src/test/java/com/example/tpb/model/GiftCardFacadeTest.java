...
public class GiftCardFacadeTest {
    ...
    @Test public void test02CanNotLoginWithInvalidUser() {
        assertThrowsLike(() -> facade.login("ManuelitaTrucho", "pass" ), GiftCardFacade.InvalidUser);
    }

    @Test public void test03CanNotLoginWithInvalidPassword() {
        UserEntity user= savedUser();
        assertThrowsLike(() -> facade.login(user.getUsername(), "burroContraseñaIncorrecta"), GiftCardFacade.InvalidUser);
    }
    ...
    @Test public void test05CanNotRedeemWithInvalidToken() {
        savedUser();
        String cardId= savedCard(100);
        assertThrowsLike(() -> facade.redeem(UUID.randomUUID(), cardId), GiftCardFacade.InvalidToken);
    }

    @Test public void test06CanNotRedeemInvalidCard() {
        UserEntity user = savedUser();
        UUID token = facade.login( user.getUsername(), user.getPassword() );
        assertThrowsLike(() -> facade.redeem( token, "tarjetaTRUCHA"), GiftCard.InvalidCard);
    }
    ...
    @Test public void test07CanNotRedeemAlreadyOwnedCard() {
        ...
        assertThrowsLike(() -> facade.redeem(token2, cardId), GiftCard.InvalidCard);
    }
    ...
    @Test public void test09CanNotCheckBalanceOfUnownedCard() {
        ...
        String cardId= savedCard( 100 );
        UUID token= facade.login(user.getUsername(), user.getPassword());
        assertThrowsLike(() -> facade.balance( token, cardId ), GiftCard.InvalidCard);
    }
    ...
    @Test public void test10CanNotCheckBalanceOfCardOwnedByOther() {
        ...
        UUID token2=facade.login(user2.getUsername(), user2.getPassword());
        assertThrowsLike(() -> facade.balance(token2, cardId), GiftCard.InvalidCard);
    }
    ...
    @Test public void test11CanChargeCardWithValidMerchant() {
        ...
        UUID token=facade.login( user.getUsername(), user.getPassword());
        facade.redeem(token, cardId);
        facade.charge(merchant.getCode(), cardId, 30, "NBA store");
    ...
    @Test public void test12CanNotChargeWithInvalidMerchant() {
        ...
        assertThrowsLike(() -> facade.charge("merchantTrucho", cardId, 30, "NBA store"), GiftCardFacade.InvalidMerchant);
    }

    @Test public void test13CanNotChargeUnownedCard() {
        MerchantEntity merchant= savedMerchant();
        String cardId= savedCard(100 );
        assertThrowsLike(() -> facade.charge(merchant.getCode(), cardId, 30, "Nba Store"), GiftCard.CargoImposible);
    }
    ...
    @Test public void test14CanNotChargeMoreThanBalance() {
        ...
        assertThrowsLike(() -> facade.charge(merchant.getCode(), cardId, 150, "moto muy cara"), GiftCard.CargoImposible);
    }
    ...
    @Test public void test15CanGetDetailsOfOwnedCard() {
        ...
        facade.redeem(token, cardId );
        facade.charge(merchant.getCode(), cardId, 30, "NBA store");
        facade.charge(merchant.getCode(), cardId, 20, "F1 store");
    ...
    @Test public void test16CanNotGetDetailsOfUnownedCard() {
        ...
        assertThrowsLike(() -> facade.details(token, cardId), GiftCard.InvalidCard);
    }
    ...
    @Test public void test17CanNotGetDetailsOfCardOwnedByOther() {
        ...
        UUID token2 = facade.login( user2.getUsername(), user2.getPassword());
        assertThrowsLike(() -> facade.details(token2, cardId), GiftCard.InvalidCard);
    }
    ...
    @Test public void test18CanNotRedeemWhenSessionIsExpired() {
        ...
        assertThrowsLike(() -> facade.redeem(token, cardId), UserSession.SessionExpired);
    }
    ...
    @Test public void test19CanNotCheckBalanceWhenSessionIsExpired() {
        ...
        assertThrowsLike(() -> facade.balance(token, cardId), UserSession.SessionExpired);
    }
    ...
    @Test public void test20CanNotGetDetailsWhenSessionIsExpired() {
        ...
        assertThrowsLike(() -> facade.details(token, cardId), UserSession.SessionExpired);
    }
    ...
    @Test public void test21MultipleChargesAreAccumulated() {
        ...
        facade.charge(merchant.getCode(), cardId, 30, "Nba Store");
        facade.charge(merchant.getCode(), cardId, 20, "F1 Store");
        facade.charge(merchant.getCode(), cardId, 10, "Harley Davidson");
